...
class ImageClassifier(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        x = batch["img"] if "img" in batch else batch[0]
    ...
    def predict_step(self, batch, batch_idx):
        inputs = batch["img"] if "img" in batch else batch[0]
    ...
    def fit(self, train_dataloader, val_dataloader=None):
        ...
        trained_model_dir = MAIN_PATH+"/trained_models"
        os.makedirs(MAIN_PATH+"/trained_models", exist_ok=True)  # Create directory if it doesn't exist
